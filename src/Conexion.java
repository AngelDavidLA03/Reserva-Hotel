...
public class Conexion
{
    ...
    String pass = "AdLa20031108";                                           // Contraseña del usuario para acceder a la base de datos (campo vacio para modificarlo segun cada persona que quiera usar el programa)
