...
SQL SECURITY DEFINER
COMMENT 'PROCEDIMIENTO UTILIZADO PARA AGREGAR VALORES A LA TABLA PRODUCTOS'
INSERT INTO Habitacion (numHab, tipoHab, pisoHab, costoHab, caracteristicasHab) 
VALUES (numHabH, tipoHabH, pisoHabH, costoHabH, caracteristicasHabH);
...
SELECT numHab, tipoHab, pisoHab, costoHab, caracteristicasHab
FROM Habitacion
ORDER BY numHab ASC;
...
SELECT numHab, tipoHab, pisoHab, costoHab, caracteristicasHab
FROM Habitacion
WHERE  SUBSTRING(habitacion.numHab,1,num) = ti;