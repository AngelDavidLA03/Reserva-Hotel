...
/* PROCEDIMIENTO UTILIZADO PARA MODIFICAR LOS PRECIOS DE LAS HABITACIONES */
CREATE DEFINER=`root`@`localhost` PROCEDURE `CHANGEpriceHab`(
	IN `hab` INT(3), 
...
CONTAINS SQL
SQL SECURITY DEFINER
COMMENT 'PROCEDIMIENTO UTILIZADO PARA MODIFICAR LOS PRECIOS DE LAS HABITACIONES'
UPDATE habitacion 
SET costoHab = price
WHERE codHab LIKE hab;